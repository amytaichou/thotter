...
**Thotter** is a basic twitter app to read and compose tweets the [Twitter API](https://apps.twitter.com/).
...
- [x] (Partial) User can switch between timeline, mentions, or profile view through a tab bar (**3 points**)
...
<img src='https://media.giphy.com/media/27sanQPaskVsdR6ypm/giphy.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
